...
import myImg from "../../Assets/myfinalimage.png";
        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I'm a swimmer diving in the ocean of Data Structure and Algorithms
              ...
              <i>
                ...
                <b className="purple">Competitive Coding and DSA.</b>
              </i>
              <br />
              <br />
